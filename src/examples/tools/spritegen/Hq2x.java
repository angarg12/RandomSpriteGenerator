...
//From:https://hq2x.googlecode.com/hg/src/se/erikalexandersson/hq2x/Hq2x.java
// License unknown. Authors: Maxim Stepin, Erika Alexandersson
// Currently unused
public class Hq2x {
	...
	private static int Interp6(int c1, int c2, int c3) {
		return (((((c1 & 0x00FF00) * 5 + (c2 & 0x00FF00) * 2 + (c3 & 0x00FF00)) & 0x0007F800) + (((c1 & 0xFF00FF)
				* 5 + (c2 & 0xFF00FF) * 2 + (c3 & 0xFF00FF)) & 0x07F807F8)) >> 3) | 0xFF000000;
	}

	private static int Interp7(int c1, int c2, int c3) {
		return (((((c1 & 0x00FF00) * 6 + (c2 & 0x00FF00) + (c3 & 0x00FF00)) & 0x0007F800) + (((c1 & 0xFF00FF)
				* 6 + (c2 & 0xFF00FF) + (c3 & 0xFF00FF)) & 0x07F807F8)) >> 3) | 0xFF000000;
	}
	...
	private static int Interp10(int c1, int c2, int c3) {
		return (((((c1 & 0x00FF00) * 14 + (c2 & 0x00FF00) + (c3 & 0x00FF00)) & 0x000FF000) + (((c1 & 0xFF00FF)
				* 14 + (c2 & 0xFF00FF) + (c3 & 0xFF00FF)) & 0x0FF00FF0)) >> 4) | 0xFF000000;
	}
	...
	private static boolean Diff(int w1, int w2) {
		...
		return ((Math.abs((YUV1 & Ymask) - (YUV2 & Ymask)) > trY)
				|| (Math.abs((YUV1 & Umask) - (YUV2 & Umask)) > trU) || (Math
		...
		for (j = 0; j < Yres; j++) {
			...
			for (i = 0; i < Xres; i++) {
				...
				case 165: {
					...
					out[outX + (outY + 1) * Xres * 2] = Interp2(c[5], c[8],
							c[4]);
					out[outX + 1 + (outY + 1) * Xres * 2] = Interp2(c[5], c[6],
							c[8]);
					break;
				}
				case 2:
				...
				case 49: {
					...
					out[outX + (outY + 1) * Xres * 2] = Interp2(c[5], c[8],
							c[4]);
					out[outX + 1 + (outY + 1) * Xres * 2] = Interp2(c[5], c[9],
							c[8]);
					break;
				}
				case 64:
				...
				case 69: {
					out[outX + outY * Xres * 2] = Interp2(c[5], c[4], c[2]);
					out[outX + 1 + outY * Xres * 2] = Interp2(c[5], c[2], c[6]);
					out[outX + (outY + 1) * Xres * 2] = Interp2(c[5], c[7],
							c[4]);
					out[outX + 1 + (outY + 1) * Xres * 2] = Interp2(c[5], c[9],
							c[6]);
					break;
				...
				case 50: {
					...
					if (Diff(w[2], w[6])) {
						...
						out[outX + 1 + outY * Xres * 2] = Interp2(c[5], c[2],
								c[6]);
					}
					out[outX + (outY + 1) * Xres * 2] = Interp2(c[5], c[8],
							c[4]);
				...
				case 81: {
					...
					out[outX + (outY + 1) * Xres * 2] = Interp2(c[5], c[7],
							c[4]);
					if (Diff(w[6], w[8])) {
						out[outX + 1 + (outY + 1) * Xres * 2] = Interp1(c[5],
								c[9]);
					} else {
						out[outX + 1 + (outY + 1) * Xres * 2] = Interp2(c[5],
								c[6], c[8]);
					}
					break;
				}
				...
				case 51: {
					if (Diff(w[2], w[6])) {
						...
						out[outX + 1 + outY * Xres * 2] = Interp9(c[5], c[2],
								c[6]);
					}
					out[outX + (outY + 1) * Xres * 2] = Interp2(c[5], c[8],
							c[4]);
				...
				case 178: {
					...
					if (Diff(w[2], w[6])) {
						...
						out[outX + 1 + outY * Xres * 2] = Interp9(c[5], c[2],
								c[6]);
						out[outX + 1 + (outY + 1) * Xres * 2] = Interp6(c[5],
								c[6], c[8]);
					}
					out[outX + (outY + 1) * Xres * 2] = Interp2(c[5], c[8],
							c[4]);
				...
				case 85: {
					...
					if (Diff(w[6], w[8])) {
						...
						out[outX + 1 + outY * Xres * 2] = Interp6(c[5], c[6],
								c[2]);
						out[outX + 1 + (outY + 1) * Xres * 2] = Interp9(c[5],
								c[6], c[8]);
					}
					out[outX + (outY + 1) * Xres * 2] = Interp2(c[5], c[7],
							c[4]);
				...
				case 113: {
					...
					if (Diff(w[6], w[8])) {
						...
						out[outX + (outY + 1) * Xres * 2] = Interp6(c[5], c[8],
								c[4]);
						out[outX + 1 + (outY + 1) * Xres * 2] = Interp9(c[5],
								c[6], c[8]);
					}
				...
				case 204: {
					...
					if (Diff(w[8], w[4])) {
						...
						out[outX + (outY + 1) * Xres * 2] = Interp9(c[5], c[8],
								c[4]);
						out[outX + 1 + (outY + 1) * Xres * 2] = Interp6(c[5],
								c[8], c[6]);
					}
				...
				case 170: {
					if (Diff(w[4], w[2])) {
						...
						out[outX + (outY + 1) * Xres * 2] = Interp6(c[5], c[4],
								c[8]);
					}
					out[outX + 1 + outY * Xres * 2] = Interp2(c[5], c[3], c[6]);
					out[outX + 1 + (outY + 1) * Xres * 2] = Interp2(c[5], c[6],
				...
				case 142: {
					if (Diff(w[4], w[2])) {
						...
						out[outX + outY * Xres * 2] = Interp9(c[5], c[4], c[2]);
						out[outX + 1 + outY * Xres * 2] = Interp6(c[5], c[2],
								c[6]);
					}
					out[outX + (outY + 1) * Xres * 2] = Interp2(c[5], c[7],
							c[8]);
				...
				case 58: {
					...
					if (Diff(w[2], w[6])) {
						...
						out[outX + 1 + outY * Xres * 2] = Interp7(c[5], c[2],
								c[6]);
					}
					out[outX + (outY + 1) * Xres * 2] = Interp1(c[5], c[8]);
					out[outX + 1 + (outY + 1) * Xres * 2] = Interp2(c[5], c[9],
				...
				case 83: {
					...
					if (Diff(w[6], w[8])) {
						...
						out[outX + 1 + (outY + 1) * Xres * 2] = Interp7(c[5],
								c[6], c[8]);
					}
					break;
				}
				case 92: {
					...
					if (Diff(w[8], w[4])) {
						...
						out[outX + (outY + 1) * Xres * 2] = Interp7(c[5], c[8],
								c[4]);
					}
					if (Diff(w[6], w[8])) {
						out[outX + 1 + (outY + 1) * Xres * 2] = Interp1(c[5],
				...
				case 233: {
					...
					if (Diff(w[8], w[4])) {
						...
						out[outX + (outY + 1) * Xres * 2] = Interp10(c[5],
								c[8], c[4]);
					}
					out[outX + 1 + (outY + 1) * Xres * 2] = Interp1(c[5], c[6]);
					break;
				...
				case 151: {
					...
					if (Diff(w[2], w[6])) {
						...
						out[outX + 1 + outY * Xres * 2] = Interp10(c[5], c[2],
								c[6]);
					}
					out[outX + (outY + 1) * Xres * 2] = Interp2(c[5], c[8],
							c[4]);
				...
				case 244: {
					...
					if (Diff(w[6], w[8])) {
						...
						out[outX + 1 + (outY + 1) * Xres * 2] = Interp10(c[5],
								c[6], c[8]);
					}
					break;
				}
	...
	private static int RGB8888toRGB565(int rgb) {
		return ((rgb & 0x00F80000) >> 8) | ((rgb & 0x0000FC00) >> 5)
				| ((rgb & 0x000000F8) >> 3);
	}

	public static int[] Parse(int[] inArr, int w, int h) {
	...
	/*
	 * public static Bitmap Parse(Resources res, int inId) { Bitmap in = null;
	 * 
	 * try{ in = BitmapFactory.decodeResource(res, inId); }catch(Exception e){
